 ...
 * tone/prohibited/brandTerms/notes) never receive a fallback because data
 * sources have no semantic for them. Pure source nodes without a structured
 * connector pass `undefined` and keep byte-identical output to the pre-fallback
 * era.
 */

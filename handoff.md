...
1. **feat(web) i18n 组件级迁移开始（3/41 组件，2026-09-03）**——Toast、UndoRedo、ConfirmDialog 已迁移到 useTranslation hook（commits `e794773`/`e697a13`）；测试设置已添加 i18n 初始化（强制中文语言，现有测试断言继续有效）；修复 zh/common.json "confirm" 值从"确认"改为"确定"以匹配原行为；全量 1460 测试通过无回归

...
* 测试总数 **3346**（2026-09-15 演示用户落地后实跑：server 1162→1185 +23＝demo 数据层 6+额度守卫 7+集成 10，同日修 #302 CI flaky 再 +1 mcp notify 回归测＝1186；web 1874→1865 净变动＝新增 demo 组件测与 UserMenu/AuthPages/ProtectedRoute 改写后的当前实跑值，顺序跑 web 97 文件 1865 全过）：

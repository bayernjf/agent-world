...
const GROUPS: GlossaryGroup[] = [
  {
    ...
    rows: [
      ...
      { std: "Node（节点）", game: "厂房 / 站 / 工位", note: "计数用「座厂房」" },
      { std: "Agent node", game: "厂房", note: "加工原料的核心节点" },
  ...
  },
  {
    ...
    title: "节点类型明细",
    rows: [
      { std: "agent", game: "厂房", note: "LLM 加工" },
      { std: "gate", game: "质检站", note: "检验 / 返工判定" },
      { std: "source", game: "原料台", note: "投料" },
      { std: "sink", game: "成品库", note: "出料" },
      { std: "imageGen", game: "AI 生图", note: "文字 → 图片" },
      { std: "videoGen", game: "AI 生视频", note: "文字 → 视频" },
      { std: "audioGen", game: "AI 生音频", note: "文字 → 语音 / 音乐" },
      { std: "http", game: "HTTP", note: "调外部 REST API" },
      { std: "code", game: "代码", note: "沙箱跑 JS / Python" },
      { std: "branch", game: "条件分支", note: "按表达式路由分支" },
      { std: "map", game: "映射", note: "JSON 模板转换" },
      { std: "loop", game: "循环", note: "逐项执行下游子图" },
      { std: "parallel", game: "并行聚合", note: "等全部分支后聚合" },
      { std: "table", game: "表格", note: "解析 / 筛选 / 排序 / 聚合" },
      { std: "database", game: "数据库", note: "SQL 查询" },
      { std: "fileParse", game: "文件解析", note: "提取 PDF / Word / PPT" },
      { std: "translate", game: "翻译", note: "译成目标语言" },
      { std: "ocr", game: "OCR", note: "识别图片文字" },
      { std: "convert", game: "文件转换", note: "PDF 提图 / 图片格式转换" },
      { std: "search", game: "搜索", note: "联网检索" },
      { std: "notify", game: "通知", note: "发群 / 邮件" },
      { std: "vcs", game: "代码仓库", note: "GitHub / GitLab" },
      { std: "human", game: "人工审批", note: "暂停产线等人工" },
      { std: "subprocess", game: "子流程", note: "调用另一张产线作函数" },
    ],
  },
  {
    id: "edges",
  ...
  },
  {
    ...
    rows: [
      ...
      { std: "brand terms", game: "品牌词库", note: "一键载入厂房" },
    ],
  },
  {
    id: "ext",
  ...
  },
  {
    ...
    rows: [
      ...
      { std: "cost report", game: "成本报表", note: "按产线 / 厂房 / 日期拆解" },

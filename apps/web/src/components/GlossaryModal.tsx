...
const GROUPS: GlossaryGroup[] = [
  ...
  },
  {
    ...
    title: "节点分组",
    rows: [
      { std: "generation", game: "AI 加工", note: "文坊(textGen) / 画坊(imageGen) / 影坊(videoGen) / 音坊(audioGen) / 通用(generic)" },
      { std: "control", game: "车间调度", note: "质检站 / 分支 / 映射 / 循环 / 并行 / 子流程" },
      { std: "data", game: "物料处理", note: "表格 / 数据库 / 文件解析 / 文件转换 / 翻译 / OCR / 代码" },
      { std: "integrations", game: "外接设备", note: "HTTP / 搜索 / 通知 / 代码仓库 / 人工审批" },
